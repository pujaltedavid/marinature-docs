...
The length of this custom id varies in the app lifetime, but it will reach 2 or 3 character length, so it is a significant advantage in front of regular uuids (3 character length allow to give unique ids up to 199,888 images $52*62^2$)
